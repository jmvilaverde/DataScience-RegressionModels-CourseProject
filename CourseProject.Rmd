...
_Note: (Please, take in consideration Summary of models as figures)._

```{r pairsMtcars, echo=FALSE, fig.height=10, fig.width=10}
pairs(mtcars, panel = panel.smooth, main = "Figure 1. Mtcars pairs comparation.", col=3+(mtcars$am>0))
```

_Figure 2.Model Step Plot._

```{r plotModel, echo=FALSE, fig.height=5.5, fig.width=5.5, fig.align='center'}
par(mfrow=c(2,2))
plot(model.Step,col=mtcars$am+1, qqline=TRUE)
title("Figure 2.Model Step Plot.")
```
